export const AUTH_MESSAGES = {
  ...
  EMAIL_MUST_BE_VALID: 'Email must be valid format.',
  ...
  FIRST_NAME_MUST_BE_AT_MOST_30_CHARACTERS:
  ...
  LAST_NAME_MUST_BE_AT_MOST_30_CHARACTERS:
    'Last name must be at most 30 characters.',
  USERAME_MUST_BE_STRING: 'Username must be string.',
  USERNAME_ALREADY_EXISTED: 'Username has already existed. Please try again.',
  USERNAME_MUST_BE_AT_LEAST_3_CHARACTERS:
    'Username must be at least 3 characters.',
  USERNAME_MUST_BE_AT_MOST_20_CHARACTERS:
